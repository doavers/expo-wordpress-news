...
- [x] Create `src/utils/notificationHelpers.ts` - Helper functions ✅
...
_This TODO document should be updated as implementation progresses and new requirements are identified._
